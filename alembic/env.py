...
# Permite importar "app.*" cuando alembic se ejecuta desde la raíz del proyecto.
...
# Sobreescribe la URL de sqlalchemy.url del .ini con la de nuestras
# Settings (que a su vez lee de variables de entorno / .env), para no
# tener la cadena de conexión duplicada en dos lugares.
...
# Metadata de nuestros modelos, usada por --autogenerate para detectar
# diferencias entre los modelos y el estado real de la base de datos.
